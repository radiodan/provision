mkdir -pv /etc/monit/conf.d/ && \
    ...
    cp -v ${RADIODAN_CONF}/radiodan-updater /etc/monit/monitrc.d/ && \
    ...
    ln -sf /etc/monit/monitrc.d/radiodan-updater /etc/monit/conf.d/radiodan-updater && \
    ln -sf /etc/monit/monitrc.d/radiodan-type-magic /etc/monit/conf.d/radiodan-type-magic && \
